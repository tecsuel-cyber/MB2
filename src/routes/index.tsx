...
import logo from "@/assets/mb2-logo.png";
...
import trabalho1 from "@/assets/trabalho-1.png";
import trabalho2 from "@/assets/trabalho-2.png";
import trabalho3 from "@/assets/trabalho-3.png";
import trabalho4 from "@/assets/trabalho-4.png";
import trabalho5 from "@/assets/trabalho-5.png";
import trabalho6 from "@/assets/trabalho-6.png";
import trabalho7 from "@/assets/trabalho-7.png";
import trabalho8 from "@/assets/trabalho-8.png";
import trabalho9 from "@/assets/trabalho-9.png";
import trabalho10 from "@/assets/trabalho-10.png";
import trabalho11 from "@/assets/trabalho-11.png";
import trabalho12 from "@/assets/trabalho-12.png";
...
const galeria = [
  { src: trabalho1, alt: "Cartões de visita produzidos para studio de beleza" },
  { src: trabalho2, alt: "Adesivo personalizado aplicado em console de videogame" },
  { src: trabalho3, alt: "Wind banner personalizado para fotografia de surf" },
  { src: trabalho4, alt: "Totem de rua adesivado com marca do cliente" },
  { src: trabalho5, alt: "Fachada de vidro adesivada com comunicação visual completa" },
  { src: trabalho6, alt: "Canecas personalizadas de Dia das Mães em produção" },
  { src: trabalho7, alt: "Criação de identidade visual em andamento no estúdio" },
  { src: trabalho8, alt: "Bandeira personalizada com escudo para time" },
  { src: trabalho9, alt: "Banner em lona sendo instalado em fachada de restaurante" },
  { src: trabalho10, alt: "Sacola kraft personalizada e carimbo de madeira para delivery" },
  { src: trabalho11, alt: "Fachada em ACM impressa para loja de roupas infantis" },
  { src: trabalho12, alt: "Caneca de vidro jateado personalizada para o Dia dos Pais" },
];
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 border-b border-border/60 bg-background/85 backdrop-blur">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          <a href="#topo" className="flex items-center gap-3">
            <img src={logo} alt="MB2 Comunicação" className="h-9 w-auto" />
          </a>
      ...
      <footer className="border-t border-border/60 bg-surface">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-5 py-10 sm:flex-row sm:justify-between">
          <img src={logo} alt="MB2 Comunicação" className="h-8 w-auto" />
